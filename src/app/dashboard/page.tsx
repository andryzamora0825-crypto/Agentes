        ...
        <div className="rounded-lg border border-white/[0.08] overflow-hidden h-[450px] sm:h-[650px] flex flex-col bg-[#141414]">
          <div className="px-4 py-2.5 border-b border-white/[0.06] flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-white/50 font-medium">Caja Ecuabet</span>
            </div>
            <a href="https://caja.ecuabet.com/#!/top/pagoNotaRetiro" target="_blank" rel="noreferrer" className="text-[11px] text-white/25 hover:text-white/40 transition-colors">Abrir ↗</a>
          </div>
          <div className="flex-1 relative bg-[#0A0A0A]" style={{ WebkitOverflowScrolling: "touch" }}>
            ...
            <div className="absolute inset-0 z-10 overflow-y-auto" style={{ WebkitOverflowScrolling: "touch" }}>
              <iframe src="https://caja.ecuabet.com/#!/top/pagoNotaRetiro" className="w-full h-full border-none bg-white" title="Caja Ecuabet" />
            </div>
          </div>
        </div>
      </div>
