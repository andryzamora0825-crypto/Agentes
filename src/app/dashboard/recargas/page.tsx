  ...
  return (
    ...
    <div className="p-4 sm:p-8 max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="bg-[#121212] border border-white/10 rounded-3xl overflow-hidden shadow-2xl min-h-[700px] flex flex-col relative group sticky top-4">
          <div className="px-5 py-4 bg-black/80 border-b border-white/10 flex items-center justify-between backdrop-blur-md">
            ...
            <a href="https://caja.ecuabet.com/#!/top/recargarCredito" target="_blank" rel="noreferrer" className="text-xs font-bold text-[#FFDE00] bg-[#FFDE00]/10 hover:bg-[#FFDE00]/20 px-3 py-1.5 rounded-full transition-colors border border-[#FFDE00]/30 shadow-[0_0_10px_rgba(255,222,0,0.1)] flex items-center gap-1.5">
