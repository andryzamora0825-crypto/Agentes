...
const GANCHOS_ECUABET = [
  ...
  "La Yapa: Mientras más líneas pongas en tu combinada, ¡más se multiplica tu ganancia!",
  ...
  "Club VIP: Accede a promociones exclusivas, límites elevados y atención preferencial",
  ...
  "App Móvil Premium: Apuesta desde cualquier lugar con la app más rápida del mercado",
...
const COPYS_POST = [
  "🔥 ¡La bola está en tu cancha! Regístrate HOY, activa tu Bono de Bienvenida y demuestra que eres experto en pronósticos. ⚽👇 Link en la bio.",
  "📈 ¿Te armaste una combinada? ¡Tu ganancia se infla! Juega tus parlays con la Yapa y sácale el jugo a este fin de semana. 💸 ¡Apuesta ahora!",
  ...
  "⚡ ¡ALERTA DE CUOTA MEJORADA! Hoy es tu día de suerte. Entra a la plataforma, encuentra el partido estrella y apuesta con la mejor cuota del mercado. 🏆",
  "💰 ¿Sabías que te pagan ANTES de que termine el partido? Sí, leíste bien. Pago Anticipado activado. ¡Corre a apostar! 🚀",
  "🎂 ¡Hoy cumples? ¡Te regalamos $5 para que festejes ganando! Activa tu Bono de Cumpleaños y haz que este día sea LEGENDARIO. 🎉",
  "🏀 NBA = La combinación ganadora. Mira los partidos en vivo, apuesta en tiempo real y cobra al instante. ¿Quién dice que no? 🔥",
  "⚽ El estadio está listo. Los equipos están en el campo. Solo falta TU apuesta. Convierte tu predicción en DINERO REAL. 💵",
  "🎯 Precisión, estrategia y ganancias. Arma tu Multi-Apuesta Express combinando deportes y multiplica tu premio. 📊",
  "💎 Bienvenido al Club VIP. Promociones exclusivas, retiros express y atención 24/7. No es solo una plataforma, es una EXPERIENCIA. 👑",
  "🥊 ¡Se viene la pelea del año! Apuesta en las mejores cuotas de boxeo y MMA en la plataforma. ¿A quién le vas? Comenta abajo 👇🔥",
  "🏈 Touchdown garantizado para tu bolsillo. La NFL está en vivo con las mejores cuotas del mercado. ¡No te quedes mirando, APUESTA! 💪",
  ...
  "📱 Tu estadio personal en el bolsillo. Descarga la App, apuesta desde donde estés y cobra en minutos. Así de fácil, así de rápido. ⚡",
  "🌟 Cada semana más premios, cada día más oportunidades. Tu Desafío Semanal está activo. ¡Cumple los retos y gana extra! 🏅",
  "🔴 ¡EN VIVO AHORA! El partido más esperado está a punto de empezar. Apuesta en tiempo real con cuotas dinámicas. ⏱️⚽",
  "💸 ¡Invita a tus panas y GANA! Por cada amigo que se registre recibes $5 gratis. Sin límite de referidos. ¡Comparte y gana! 🤝",
  ...
  "⚽ La Liga Pro está que arde y las cuotas están al rojo vivo. Apuesta en tu equipo favorito y celebra con toda la hinchada. 🎉",
  ...
  "🃏 Poker Night is ON. Compite contra los mejores, bluffea como profesional y llévate el pozo del torneo. 🏆",
  "📊 Datos > Suerte. Usa nuestras herramientas de análisis deportivo y convierte tus apuestas en una ciencia. Apuesta inteligente. 🧠",
  ...
  "💪 El verdadero campeón no se queda en la tribuna. Baja al campo, haz tu jugada y demuestra que tienes olfato ganador. Te esperamos. 🏟️",
  ...
  "🌎 Champions League, Premier, La Liga, Liga Pro... Todos los torneos del mundo en una sola plataforma. Tu ventana al deporte global. 🌐",
  "🍀 Hoy la suerte está de tu lado, lo presiento. Entra, elige tu evento favorito y demuéstralo. ¡El ganador podrías ser TÚ! 🎯",
  "🚀 De cero a héroe en un clic. Regístrate, reclama tu bono y empieza tu camino de ganancias HOY. Donde empiezan los ganadores. 🏁",
];
